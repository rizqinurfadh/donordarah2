...
<body>
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Formulir Butuh Donor</h2>
                    </div>
                    <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder=" Alamat"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
