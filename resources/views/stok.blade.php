            ...
            <div class="row justify-content-center">
                <div class="col-lg-15">
                    <div class="section_title text-center mb-55">
                        <h3><span>Stok Darah di Rumah Sakit</span></h3></br>
				<div class="progress-table-wrap">
					<div class="progress-table">
						<div class="table-head">
							<div class="serial">No</div>
							<div class="country">Rumah Sakit</div>
							<div class="visit">Stok Darah</div>
							<div class="percentage">Presentase</div>
						</div>
						<div class="table-row">
							<div class="serial">01</div>
							<div class="country">RS Universitas Airlangga</div>
						...
						<div class="table-row">
							...
							<div class="country">RSUD Dr.Moh.Soewandhi</div>
							<div class="visit">400</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country">RSUD Dr.Soetomo</div>
							<div class="visit">240</div>
							<div class="percentage">
								<div class="progress">
									<div class="progress-bar color-3" role="progressbar" style="width: 30%"
						...
						<div class="table-row">
							...
							<div class="country">RSUD Bhakti Dharma Husada</div>
							<div class="visit">330</div>
							<div class="percentage">
								<div class="progress">
									<div class="progress-bar color-4" role="progressbar" style="width: 45%"
						...
						<div class="table-row">
							...
							<div class="country">RS Brawijaya</div>
							<div class="visit">100</div>
							<div class="percentage">
								<div class="progress">
									<div class="progress-bar color-5" role="progressbar" style="width: 16%"
						...
						<div class="table-row">
							...
							<div class="country">RS Bunda</div>
